...
export const FILTER_STYLES = {
  ...
  // Checkbox styles
  checkbox: `border-[${MILK_COLORS.muted}] data-[state=checked]:bg-[#F36] data-[state=checked]:border-[#F36] data-[state=checked]:text-white rounded-[4px] pointer-events-none`,
